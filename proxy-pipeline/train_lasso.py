...
def main(_):
    ...
    if FLAGS.train:
        ...
        # Define the model
        regressor = Lasso(alpha=FLAGS.alpha, fit_intercept=FLAGS.fit_intercept, precompute=FLAGS.precompute, copy_X=FLAGS.copy_X, 
                    max_iter=FLAGS.max_iter, tol=FLAGS.tol, warm_start=FLAGS.warm_start, positive=FLAGS.positive, 
