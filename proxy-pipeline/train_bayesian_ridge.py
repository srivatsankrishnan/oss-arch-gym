...
def main(_):
    ...
    if FLAGS.train:
        ...
        # Define the model
        regressor0 = BayesianRidge(n_iter=FLAGS.n_iter, tol=FLAGS.tol, alpha_1=FLAGS.alpha_1, alpha_2=FLAGS.alpha_2,
        ...
        # Define the model
        regressor1 = BayesianRidge(n_iter=FLAGS.n_iter, tol=FLAGS.tol, alpha_1=FLAGS.alpha_1, alpha_2=FLAGS.alpha_2,
                                  lambda_1=FLAGS.lambda_1, lambda_2=FLAGS.lambda_2, alpha_init=FLAGS.alpha_init, 
                                  lambda_init=FLAGS.lambda_init, compute_score=FLAGS.compute_score, 
                                  fit_intercept=FLAGS.fit_intercept, copy_X=FLAGS.copy_X, verbose=FLAGS.verbose)
