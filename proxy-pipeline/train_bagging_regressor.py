...
flags.DEFINE_integer('n_jobs', 1, 'Number of jobs to run in parallel for both fit and predict')
flags.DEFINE_integer('random_state', None, 'Seed used by the random number generator') # check
