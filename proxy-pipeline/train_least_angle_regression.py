...
def main(_):
    ...
    if FLAGS.train:
        ...
        # Define the model
        regressor = Lars(fit_intercept=FLAGS.fit_intercept, verbose=FLAGS.verbose, precompute=FLAGS.precompute, 
                         n_nonzero_coefs=FLAGS.n_nonzero_coefs, eps=FLAGS.eps, copy_X=FLAGS.copy_X, fit_path=FLAGS.fit_path, 
