...
def main(_):
    ...
    exp_name = 'multi_task_elastic_net'
    ...
    if FLAGS.train:
        ...
        # Define the model
        regressor = MultiTaskElasticNet(alpha=FLAGS.alpha, l1_ratio=FLAGS.l1_ratio, fit_intercept=FLAGS.fit_intercept,
                                        copy_X=FLAGS.copy_X, max_iter=FLAGS.max_iter, tol=FLAGS.tol, warm_start=FLAGS.warm_start,
