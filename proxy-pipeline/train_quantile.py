...
flags.DEFINE_enum('solver', 'highs', ['highs-ds', 'highs-ipm', 'highs', 'interior-point', 'revised simplex'], 
...
def main(_):
    ...
    if FLAGS.train:
        ...
        # Define the model
        regressor = QuantileRegressor(quantile=FLAGS.quantile, alpha=FLAGS.alpha, fit_intercept=FLAGS.fit_intercept, solver=FLAGS.solver)
