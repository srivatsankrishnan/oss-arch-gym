...
from SniperEnv import SniperEnv
from envHelpers import helpers
class SniperEnvWrapper(dm_env.Environment):
...
def make_sniper_env(seed: int = 12234,
                     max_steps: int = 100) -> dm_env.Environment:
  """Returns DRAMSys environment."""
  environment = SniperEnvWrapper(SniperEnv())
