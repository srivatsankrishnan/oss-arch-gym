...
def main(_):
    ...
    for suggestion in suggestions:
        ...
        # vizier_actions are float type, therefore convert it to int 
        int_vizier_actions = []
        for action in vizier_actions:
            new_action = int(float(action))
            int_vizier_actions.append(new_action)
        
        
        # print("Vizier Actions", vizier_actions)
        # print("New Vizier Actions", int_vizier_actions)
        action = np.asarray(int_vizier_actions)
