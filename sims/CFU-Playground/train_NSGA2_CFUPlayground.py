...
flags.DEFINE_string('traject_dir', 'NSGA2_trajectories', 'Directory to save the dataset.')
...
def main(_):
    ...
    env = CFUPlayground_wrapper.make_cfuplaygroundEnv(target_vals = [1000, 1000],rl_form='NSGA2', reward_type = FLAGS.reward_formulation, max_steps = FLAGS.num_steps, workload = FLAGS.workload)
