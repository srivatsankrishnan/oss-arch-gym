...
flags.DEFINE_string('traject_dir', 'quasi_random_trajectories', 'Directory to save the dataset.')
...
def main(_):
    ...
    env = CFUPlayground_wrapper.make_cfuplaygroundEnv(target_vals = [1000, 1000],rl_form='QUASIRANDSOM', reward_type = FLAGS.reward_formulation, max_steps = FLAGS.num_steps, workload = FLAGS.workload)
