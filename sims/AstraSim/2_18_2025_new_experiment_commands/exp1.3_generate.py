...
for workload in ["gpt3_175b", "gpt3_13b", "vit_large", "vit_base"]:
        ...
        for num_agents in num_agents_range:
            for prob in prob_mut_range:
                cur_yml = {
                    ...
                    "NETWORK": f"astrasim_220_example/network_input_1.3.yml",
                    "SYSTEM": f"astrasim_220_example/system_input_1.3.json",
                    "WORKLOAD": f"astrasim_220_example/workload_cfg_1.3_{workload}.json"
                }
                ...
                if prob == 0.01:
                    ...
                    prob_str = '05'
                file_name = f"exp1.3/experiment1.3_{step}_{num_agents}_{prob_str}_{workload}.yml"
        ...
        for ant in ant_count:
            for greed in greediness_range:
                for eva in evaporation_range:
                    ...
                    file_name = f"exp1.3/experiment1.3_{step}_{ant}_{greed_str}_{eva_str}_{workload}.yml"
    ...
    for step in steps_range:
        for rand in rand_state:
            ...
            file_name = f"exp1.3/experiment1.3_{step}_{rand}_{workload}.yml"
