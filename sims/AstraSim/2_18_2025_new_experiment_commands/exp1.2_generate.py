...
for workload in ["gpt3_175b", "gpt3_13b", "vit_large", "vit_base"]:
        ...
        for num_agents in num_agents_range:
            for prob in prob_mut_range:
                cur_yml = {
                    ...
                    "PROB_MUT": prob,
                    "REWARD": "both",
                    "KNOBS": f"astrasim_220_example/knobs_1.py",
                    "NETWORK": f"astrasim_220_example/network_input_1.2.yml",
                    "SYSTEM": f"astrasim_220_example/system_input_1.2.json",
                    "WORKLOAD": f"astrasim_220_example/workload_cfg_1.2_{workload}.json"
                }
                ...
                if prob == 0.01:
                    ...
                    prob_str = '05'
                file_name = f"exp1.2/experiment1.2_{step}_{num_agents}_{prob_str}_{workload}.yml"
        ...
        for ant in ant_count:
            for greed in greediness_range:
                for eva in evaporation_range:
                    ...
                    file_name = f"exp1.2/experiment1.2_{step}_{ant}_{greed_str}_{eva_str}_{workload}.yml"
    ...
    for step in steps_range:
        for rand in rand_state:
            ...
            file_name = f"exp1.2/experiment1.2_{step}_{rand}_{workload}.yml"
