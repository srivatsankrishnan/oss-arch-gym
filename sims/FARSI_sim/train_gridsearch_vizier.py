...
flags.DEFINE_string('traject_dir', 
                    'gridsearch_FARSIsim_trajectories', 'Directory to save the dataset.')
...
def wrap_in_envlogger(env, envlogger_dir): 
    ...
    metadata = {
        'agent_type': 'GRIDSEARCH_FARSIsim_EI',
...
def main(_):
    """We use grid search algorithm on the action parameter space of FARSI simulator environment
    ...
    log_path = os.path.join(FLAGS.summary_dir, 'gridsearch__FARSI_sim_logs', FLAGS.reward_formulation, exp_name)
