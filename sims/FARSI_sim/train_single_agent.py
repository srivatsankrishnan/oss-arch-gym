...
_WORKLOAD = flags.DEFINE_string('workload', 'edge_detection', 'Workload to run for training')
...
_REWARD_FORM = flags.DEFINE_string('reward_form', 'power', 'Reward form.')
# Scale reward
...
def build_experiment_config():
    ...
    env = FARSI_sim_wrapper.make_FARSI_sim_env(rl_form=FLAGS.rl_form,
